defmodule Advent.Day6 do
  ...
  iex> Day6.redistribute([2,4,1,2])
  [3,1,2,3]

  iex> Day6.redistribute([3,1,2,3])
  [0,2,3,4]

  iex> Day6.redistribute([0,2,3,4])
  [1,3,4,1]

  iex> Day6.redistribute([1,3,4,1])
  [2,4,1,2]
  """
  ...
  def bench do
    Benchee.run(
      %{
        "day 6, parts 1+2" => fn -> Advent.data(6, parse: true) |> parts() end
      },
